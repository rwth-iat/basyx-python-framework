...
from server.routes import submodel, aas, aasx_file_server, aas_registry_server, submodel_registry_server, discovery_server
...
discovery_router = aasx_file_server.DiscoveryRouter(central_object_store)
...
app.include_router(discovery_router.router, prefix=prefix + "/discovery")
